...
- **RATE**
When displaying the raw results, the `summary` method also displays the estimated RATEs and their confidence intervals. Further investigation of the RATEs results is provided by the `plot` method. If the optional argument `target` is set to `"RATE"`, the method plots the estimated TOCs for the each considered threshold value $u$. 
