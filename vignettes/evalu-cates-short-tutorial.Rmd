...
We now proceed to estimate the CATEs using the causal forest. We divide our data set into two subsamples: 
...
In a first step we display the estimated CATEs distributions in two plots: 

1. Kernel density of the out-of-sample CATE predictions

2. Out-of-sample CATE predictions arranged in ascending order together with pointwise $95\%$ confidence intervals. (To enhance visualization, we smooth the standard errors by a Nadaraya-Watson regression.)
